...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext.prototype._renewToken = function (resource, callback) {
        ...
        // include login_hint only if upn is present
        if (this._getLoginHint()) {
            urlNavigate += '&login_hint=' + encodeURIComponent(this._getLoginHint());
        }

        // don't add domain_hint twice if user provided it in the extraQueryParameter value
        if (!this._urlContainsQueryStringParameter("domain_hint", urlNavigate) && this._getDomainHint()) {
    ...
    AuthenticationContext.prototype._getDomainHint = function () {
        if (this._user && this._user.profile && this._user.profile.hasOwnProperty('upn')) {
            if (this._user.profile.upn.indexOf('@') > -1) {
